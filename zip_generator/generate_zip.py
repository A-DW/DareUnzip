...
payload_source_path = os.path.join(script_dir, '..', 'malware_simulator', 'payload.py')
...
if not os.path.exists(payload_source_path):
    ...
    if os.path.exists(output_zip_path):
        ...
        print(f"Failed to create zip file at: {output_zip_path}")
